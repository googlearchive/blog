...
Exciting news - Polymer 0.5.1 is now released! This release corrects a regression 0.5.0, and the two together represent lots of updates and fixes. This one even gets its own table of contents:

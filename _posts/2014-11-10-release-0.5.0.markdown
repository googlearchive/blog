...
* [_Breaking_ `polymer.html` includes the unminified, concatenated source](#0-5-0_polymerhtml)
...
* [_Breaking/Improved_ `core-ajax`](#0-5-0_coreajax)
* [_Breaking_ `firebase_element`](#0-5-0_firebase)
...
## <a name="0-5-0_polymerhtml"></a>_Breaking_ `polymer.html` contains concatenated, unminified source.
...
## <a name="0-5-0_coreajax"></a>_Breaking_/_Improving_ `core-ajax` changes
...
## <a name="0-5-0_firebase"></a>_Breaking_ Updates to `firebase-element`
...
Phew, lots of exciting updates here. Check out the [full release notes](https://github.com/Polymer/polymer/releases/tag/0.5.0) for even more detail.

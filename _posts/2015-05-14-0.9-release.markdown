...
The 0.9 version of the library is now [released!](TODO: Update the link)
...
In short - probably yes. We're coming very close to a 1.0 version, but today's release cuts very closely to what that library will look like. With elements at the ready, nearly all 0.5 projects should be able to start upgrading. Make sure to take a look at the [migration guide](https://www.polymer-project.org/0.9/docs/migration.html) to get a sense of what has changed since 0.5.
